...
function easy(){
    ...
    for(var i=0;i<easyLevel.length;++i)
    {
        ...
        {
            document.getElementById(indx).value =easyLevel[i][j];
            if(easyLevel[i][j]!=null)
            {
                document.getElementById(indx).style.backgroundColor='rgb(217, 218, 208)'
            document.getElementById(indx).disabled=true
            }
            ++indx;
        }
    }
...
function medium(){
    ...
    for(var i=0;i<mediumLevel.length;++i)
    {
        ...
        {
            document.getElementById(indx).value =mediumLevel[i][j];
...
function hard(){
    ...
    for(var i=0;i<hardLevel.length;++i)
    {
        ...
        {
            document.getElementById(indx).value =hardLevel[i][j];
...
function validateRow()
{
    for(var i=0;i<=80;i+=9)
    {
        ...
        for(var j=i;j<i+9;++j)
        {
          arr1[indx]=document.getElementById(j).value;
          indx++;
        }
        var a='';
        arr1=arr1.sort();
